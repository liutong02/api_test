...
class TestUserManager(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.user.login()
        cls.username = UserManagerData.user_case_data.get('username')
        cls.new_username = UserManagerData.user_case_data.get('new_username')
        cls.password = UserManagerData.user_case_data.get('password')
